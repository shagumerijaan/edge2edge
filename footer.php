...
<ul>
    <li><a href="<?=$webRoot?>"><i class="fa fa-chevron-circle-right"></i> Home</a></li>
    <li><a href="<?=$webRoot?>about-us.php"><i class="fa fa-chevron-circle-right"></i> About Us</a></li>
    <li><a href="<?=$webRoot?>services.php"><i class="fa fa-chevron-circle-right"></i> Services</a></li>
    <li><a href="<?=$webRoot?>gallery.php"><i class="fa fa-chevron-circle-right"></i> Gallery</a></li>
    <li><a href="<?=$webRoot?>contact-us.php"><i class="fa fa-chevron-circle-right"></i> Contact Us</a></li>
    <li><a href="<?=$webRoot?>get-a-quote.php"><i class="fa fa-chevron-circle-right"></i> Get A Quote</a></li>
    <li><a href="<?=$webRoot?>terms.php"><i class="fa fa-chevron-circle-right"></i> Terms & Conditions</a></li>
    <li><a href="<?=$webRoot?>Booking.php"><i class="fa fa-chevron-circle-right"></i> Booking</a></li>
</ul>
      </div>           </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-wid">
                        ...
                        <ul class="opening-hour">
                            ...
                            <li>Email: <span><a href="mailto:Info@edge2edgecleaning.com.au">Info@edge2edgecleaning.com.au</a></span></li>
    ...
    <div class="footer-copyright-area">
        ...
        <div class="row">
            <div class="col-lg-9 info">
                <a href="info@edge2edgecleaning.com.au"><i class="fa fa-envelope"></i> Mail at info@edge2edgecleaning.com.au</a> 
...
<script type="application/ld+json">
{
  ...
  "image": "https://www.edge2edgecleaning.com.au/images/logo.png",
  "@id": "https://www.edge2edgecleaning.com.au",
